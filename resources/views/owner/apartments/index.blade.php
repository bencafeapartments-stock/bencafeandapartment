...
@section('content')
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                ...
                                <div
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <!-- @if ($apartment['status'] == 'available')
                                                <a href="{{ route('owner.apartments.assign', $apartment['id']) }}"
                    ...
                    @else
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-500 mb-6 max-w-sm mx-auto">
                                Get started by creating your first apartment. You can add all the details, amenities, and
                                pricing information.
                            </p>
                            <a href="{{ route('owner.apartments.create') }}"
                                class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-semibold rounded-xl hover:from-blue-600 hover:to-blue-700 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 shadow-lg shadow-blue-500/25">
            ...
            <!-- <div class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-sm border border-gray-200/50">
                <div class="px-6 py-5">
                    ...
                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                        <a href="{{ route('owner.apartments.create') }}"
                            class="group flex flex-col items-center p-5 bg-gradient-to-br from-blue-50 to-blue-100/50 hover:from-blue-100 hover:to-blue-200/50 rounded-2xl border border-blue-200/50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                            <div
                                class="w-12 h-12 bg-blue-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-plus text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-blue-700">Add Apartment</span>
                        </a>

                        <a href="#"
                            class="group flex flex-col items-center p-5 bg-gradient-to-br from-green-50 to-green-100/50 hover:from-green-100 hover:to-green-200/50 rounded-2xl border border-green-200/50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                            <div
                                class="w-12 h-12 bg-green-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-users text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-green-700">Assign Tenants</span>
                        </a>

                        <a href="#"
                            class="group flex flex-col items-center p-5 bg-gradient-to-br from-amber-50 to-orange-100/50 hover:from-amber-100 hover:to-orange-200/50 rounded-2xl border border-amber-200/50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                            <div
                                class="w-12 h-12 bg-amber-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-tools text-white text-xl"></i>
                            </div>
                        ...
                        <a href="{{ route('owner.reports') }}"
                            class="group flex flex-col items-center p-5 bg-gradient-to-br from-purple-50 to-purple-100/50 hover:from-purple-100 hover:to-purple-200/50 rounded-2xl border border-purple-200/50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                            <div
                                class="w-12 h-12 bg-purple-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-chart-bar text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-purple-700">Reports</span>
                        </a>
                    </div>
                </div>
            </div> -->
    ...
    @push('scripts')
        <script>
            function showApartmentDetails(apartmentId) {
                ...
                fetch(`/owner/apartments/${apartmentId}/details`)
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100/50 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/50">
                            ...
                            ${tenant ? `
                                    ...
                                    <a href="/owner/apartments/${apartment.id}/assign"
            ...
            function showTenantDetails(apartmentId) {
                ...
                fetch(`/owner/apartments/${apartmentId}/tenant-details`)
                    .then(response => response.json())
                    .then(data => {
                        let detailsHtml = '';
                        if (data.tenant) {
            ...
            function openEditModal(apartmentId) {
                ...
                fetch(`/owner/apartments/${apartmentId}/edit-data`)
                    .then(response => response.json())
                    .then(data => {
                        const apartment = data.apartment;

                        // Update form action
                        document.getElementById('editApartmentForm').action = `/owner/apartments/${apartmentId}`;
