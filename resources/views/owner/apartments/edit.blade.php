...
@section('content')
    <div class="space-y-6">
            ...
            <div>
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-4">
                        <li>
                            <a href="{{ route('owner.apartments.index') }}" class="text-gray-400 hover:text-gray-500">
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('owner.apartments.update', $apartment->id ?? ($apartmentId ?? 0)) }}" method="POST"
